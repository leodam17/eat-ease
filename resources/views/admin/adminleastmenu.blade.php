...
<h1 class="text-5xl font-extrabold text-center text-gray-800 dark:text-black mt-3 mb-6">
    LEAST ORDERED MENU!
</h1>

@if($leastOrderedMenu)
    <div style="border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); padding: 16px; max-width: 400px; margin: 16px auto; max-height: 585px; overflow-y: auto;">
