...
<div class="bg-[#e7e3d8] dark:bg-[#1e1a14] text-[#4a3b2f] dark:text-[#e7d7c4] py-10">
    <div class="container mx-auto px-4 text-center md:text-left">
        ...
        <br><br>
        <a href="{{ route('admin.home') }}" class="bg-[#d6a670] text-white py-3 px-6 rounded-md shadow-md hover:bg-[#bf8f5a] dark:bg-[#a77e4a] dark:text-white dark:hover:bg-[#8f6c45] transition">
            Back to Home
        </a>
    </div>
</div>
